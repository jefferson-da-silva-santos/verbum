/**
 * VERBUM — app/(auth)/onboarding.tsx  [CORRIGIDO]
 * FIX: useSafeAreaInsets substitui paddingTop: 64 fixo.
 */
...
export default function OnboardingScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: tokens.bgPrimary }}>
      ...
      {/* Logo — padding dinâmico com safe area */}
      <View style={{
        alignItems: 'center',
        paddingTop:    insets.top + 24,   // FIX: era 64 fixo
        paddingBottom: 20,
      }}>
        <Text style={{
          fontSize: 30, fontWeight: '700', fontFamily: 'serif',
        ...
        {SLIDES.map((slide, i) => (
          ...
          >
            ...
            <Text style={{
              ...
              color: tokens.textPrimary, textAlign: 'center',
            }}>
              {slide.title}
            </Text>
      ...
      {/* Botões — padding com safe area no rodapé */}
      <View style={{
        paddingHorizontal: 24,
        paddingBottom: insets.bottom + 24,   // FIX: respeita gesto home do Android
        paddingTop: 8,
        gap: 12,
      }}>
        {isLast ? (
